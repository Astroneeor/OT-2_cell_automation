...
metadata = {
    "protocolName": "Testing out the touch tip feature",
    "description": """Touch tip feature test for aspirating media from wells to see how much is left
    This is needed to basically get rid of the bubbles on the tip when aspirating, otherwise it leads
    to a VERY inconsistent measurement""",
    "author": "Neeor Alam"
}
