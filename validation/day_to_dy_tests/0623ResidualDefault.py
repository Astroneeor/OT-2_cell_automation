...
metadata = {
    "protocolName": "Residual testing Default plates with half plate",
...
def adding_buffer(source, pipette, well_plate):
    ...
    # p1000.pick_up_tip()
    p1000.distribute(200, reservoir.bottom(5), [well_list], new_tip="never", disposal_volume=25)
    # p1000.drop_tip()
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    protocol.pause("Are the plates weighed yet?")
